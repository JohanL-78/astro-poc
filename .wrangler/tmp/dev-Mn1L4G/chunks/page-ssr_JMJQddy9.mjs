...
var a, c$1, u, l, p, d = { exports: {} }; /* @__PURE__ */ c$3((p || (p = 1, (function(e2, t2) {
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import('./stegaEncodeSourceMap_DZZmdRV_.mjs').then(function(n) {
...
const pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = defer(() => import('./browser_SoR-2ztN.mjs').then(n => n.b)).pipe(
...
const sanityClient = createClient(
            {"apiVersion":"v2023-08-24","projectId":"dd2las0t","dataset":"production","useCdn":false,"stega":{"studioUrl":"\u002Fstudio"}}
          );

globalThis.sanityClient = sanityClient;

export { sanityClient as a, isRecord as i, stegaClean as s };
